      ...
      'ExpressionStatement': function(node) {
        ...
        context.report({
          ...
          fix: function(fixer) {
            ...
            var body = replaceDeclarationIfNeeded(bodyTxt, firstFnParamName, variableBeingLooped)
            bodySplit = loopVariableDefinedInBlock(variableBeingLooped, firstFnParamName, null, body, false)
